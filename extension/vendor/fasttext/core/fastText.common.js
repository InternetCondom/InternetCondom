var fastTextModule = (() => {
  ...
  return function (moduleArg = {}) {
    ...
    var wasmBinaryFile;
    wasmBinaryFile = "fastText.common.wasm";
    ...
    var _wasmfs_create_jsimpl_backend = createExportWrapper(
      "wasmfs_create_jsimpl_backend",
    );
    var _wasmfs_create_memory_backend = createExportWrapper(
    ...
    var dynCall_fiij = (Module["dynCall_fiij"] =
      createExportWrapper("dynCall_fiij"));
    var dynCall_viijf = (Module["dynCall_viijf"] =
      createExportWrapper("dynCall_viijf"));
