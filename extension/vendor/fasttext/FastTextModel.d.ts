...
export declare class FastTextModel {
  ...
  heapToFloat32: (r: { ptr: any; size: any; buffer: any }) => Float32Array;
  /**
   * isQuant
   *
  ...
  getNearestNeighbors(
    word: string,
    k?: number,
  ): import("./types/misc").Vector<import("./types/misc").Pair<number, string>>;
  /**
   * getAnalogies
   *
   ...
   *
   */
  getWords(): import("./types/misc").Pair<
    import("./types/misc").Vector<string>,
    import("./types/misc").Vector<number>
  >;
  /**
   * getLabels
   *
   ...
   *
   */
  getLabels(): import("./types/misc").Pair<
    import("./types/misc").Vector<string>,
    import("./types/misc").Vector<number>
  >;
  /**
